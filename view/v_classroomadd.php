	...
	<div class="card col-sm-12 col-md-6 mb-5 mx-auto text-white bg-white">
		 <h2 class="pt-4 text-dark card-title text-center">Add New Classroom</h2>
				...
				<h3 class="pt-4 text-dark card-title">Notes</h3><h4 class=" bg-danger text-white"></h4>
				  <input type="text" class="col-12 single-input-primary form-control form-control-lg border border-info" name="status" required="required" pattern="[A-Za-z0-9 ]{3,40}" placeholder="Only accept alphabetic, numeric characters and spaces."/>			
				  <div class="pt-3">
