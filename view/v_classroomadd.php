...
if (isset($_POST['submit'])) {
	...
	if (
		...
		$id = $controller->AddClassroom($name, $tutor_id, $note);
...
<div class="container">
	<div class="card col-sm-12 col-md-6 mb-5 mx-auto text-white bg-white">
		...
		<form action="#" method="post" class="center p-3 pb-4">
			...
			<h4 class=" bg-danger text-white"></h4>
			<input type="text" class="col-12 single-input-primary form-control form-control-lg border border-info" name="note" required="required" pattern="^.{1,40}$" placeholder="Maximum of 40 characters." />
			<div class="pt-3">
