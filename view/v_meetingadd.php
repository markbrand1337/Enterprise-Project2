...
<div class="container">
	<div class="card col-sm-12 col-md-6 mb-5 mx-auto text-white bg-white">
		...
		<form action="#" method="post" class="center p-3 pb-4">
			<h3 class="pt-4 text-dark card-title">Meeting Date</h3>
			...
			<h4 class=" bg-danger text-white"></h4>
			<input type="text" class="col-12 single-input-primary form-control form-control-lg border border-info" name="note" required="required" pattern="^.{1,40}$" placeholder="Only accept alphabetic, numeric characters and spaces." />
			<div class="pt-3">
