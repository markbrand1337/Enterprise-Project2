	...
	<div class="card col-sm-12 col-md-6 mb-5 mx-auto text-white bg-white">
		 <h2 class="pt-4 text-dark card-title text-center">Add New User</h2>
				<form action="#" method="post" class="center p-3 pb-4">
				  <h3 class="pt-4 text-dark card-title">First Name</h3><h4 class=" bg-danger text-white"></h4>
				  ...
				  <h3 class="pt-4 text-dark card-title">Last Name</h3><h4 class=" bg-danger text-white"></h4>
				  ...
				  <h3 class="pt-4 text-dark card-title">Email</h3><h4 class=" bg-danger text-white"></h4>
				  ...
				  <h3 class="pt-4 text-dark card-title">Password</h3><h4 class=" bg-danger text-white"></h4>
				  ...
				  <h3 class="pt-4 text-dark card-title">Confirm Password</h3><h4 class=" bg-danger text-white"></h4>
