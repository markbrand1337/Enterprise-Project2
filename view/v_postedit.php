		...
		<div class="card col-md-8 col-sm-12 mt-3 mx-auto">
			<div class="card-body">
				...
				<form method="POST">
					...
					<textarea type="text" class="col-12 single-input-primary form-control form-control-lg border border-info mt-3" name="content" required="required" pattern="^.{1,150}$" rows="1" placeholder="What do you want to say?" value="<?= $onepost->content ?>"><?= $onepost->content ?></textarea>
					<div class="pt-3">
